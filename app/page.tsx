...
export default function BoardsPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#000", color: "#fff", fontFamily: "Arial", padding: "40px" }}>
      {/* Header */}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
        {boards.map((board, idx) => (
          <div key={idx} style={{ background: "#111", padding: "20px", borderRadius: "8px", border: "1px solid #3b82f6" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <h2 style={{ cursor: "pointer" }} onClick={() => setExpandedBoard(expandedBoard === board ? null : board)}>{board}</h2>
